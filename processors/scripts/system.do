...
add wave -noupdate -group {core1 ROB Signals} /system_tb/DUT/CORE1/ROB/ROB_array_by_entry
...
WaveRestoreCursors {{Cursor 1} {4265548 ps} 0}
...
update
WaveRestoreZoom {0 ps} {5000593 ps}
