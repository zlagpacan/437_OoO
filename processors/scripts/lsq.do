...
add wave -noupdate -expand -group {Top Level Signals} -expand -group {d$ read kill} /lsq_tb/DUT_dcache_read_kill_valid_0
add wave -noupdate -expand -group {Top Level Signals} -expand -group {d$ read kill} /lsq_tb/expected_dcache_read_kill_valid_0
add wave -noupdate -expand -group {Top Level Signals} -expand -group {d$ read kill} /lsq_tb/DUT_dcache_read_kill_LQ_index_0
add wave -noupdate -expand -group {Top Level Signals} -expand -group {d$ read kill} /lsq_tb/expected_dcache_read_kill_LQ_index_0
add wave -noupdate -expand -group {Top Level Signals} -expand -group {d$ read kill} /lsq_tb/DUT_dcache_read_kill_valid_1
add wave -noupdate -expand -group {Top Level Signals} -expand -group {d$ read kill} /lsq_tb/expected_dcache_read_kill_valid_1
add wave -noupdate -expand -group {Top Level Signals} -expand -group {d$ read kill} /lsq_tb/DUT_dcache_read_kill_LQ_index_1
add wave -noupdate -expand -group {Top Level Signals} -expand -group {d$ read kill} /lsq_tb/expected_dcache_read_kill_LQ_index_1
...
add wave -noupdate -expand -group {Internal Signals} -expand -group {LQ addr calc stage} /lsq_tb/DUT/LQ_addr_calc_stage_valid
add wave -noupdate -expand -group {Internal Signals} -expand -group {LQ addr calc stage} /lsq_tb/DUT/next_LQ_addr_calc_stage_valid
add wave -noupdate -expand -group {Internal Signals} -expand -group {LQ addr calc stage} /lsq_tb/DUT/LQ_addr_calc_stage_linked
add wave -noupdate -expand -group {Internal Signals} -expand -group {LQ addr calc stage} /lsq_tb/DUT/next_LQ_addr_calc_stage_linked
add wave -noupdate -expand -group {Internal Signals} -expand -group {LQ addr calc stage} /lsq_tb/DUT/LQ_addr_calc_stage_conditional
add wave -noupdate -expand -group {Internal Signals} -expand -group {LQ addr calc stage} /lsq_tb/DUT/next_LQ_addr_calc_stage_conditional
add wave -noupdate -expand -group {Internal Signals} -expand -group {LQ addr calc stage} /lsq_tb/DUT/LQ_addr_calc_stage_reg_file_read_base_addr
add wave -noupdate -expand -group {Internal Signals} -expand -group {LQ addr calc stage} /lsq_tb/DUT/next_LQ_addr_calc_stage_reg_file_read_base_addr
add wave -noupdate -expand -group {Internal Signals} -expand -group {LQ addr calc stage} /lsq_tb/DUT/LQ_addr_calc_stage_imm14
add wave -noupdate -expand -group {Internal Signals} -expand -group {LQ addr calc stage} /lsq_tb/DUT/next_LQ_addr_calc_stage_imm14
add wave -noupdate -expand -group {Internal Signals} -expand -group {LQ addr calc stage} /lsq_tb/DUT/LQ_addr_calc_stage_LQ_index
add wave -noupdate -expand -group {Internal Signals} -expand -group {LQ addr calc stage} /lsq_tb/DUT/next_LQ_addr_calc_stage_LQ_index
add wave -noupdate -expand -group {Internal Signals} -expand -group {LQ addr calc stage} /lsq_tb/DUT/LQ_addr_calc_stage_operand_bus_select
add wave -noupdate -expand -group {Internal Signals} -expand -group {LQ addr calc stage} /lsq_tb/DUT/next_LQ_addr_calc_stage_operand_bus_select
add wave -noupdate -expand -group {Internal Signals} -expand -group {LQ addr calc stage} /lsq_tb/DUT/LQ_addr_calc_stage_forwarded_read_base_addr
add wave -noupdate -expand -group {Internal Signals} -expand -group {LQ addr calc stage} /lsq_tb/DUT/LQ_addr_calc_stage_read_addr
add wave -noupdate -expand -group {Internal Signals} -expand -group {LQ operand update stage} /lsq_tb/DUT/LQ_operand_update_stage_valid
add wave -noupdate -expand -group {Internal Signals} -expand -group {LQ operand update stage} /lsq_tb/DUT/next_LQ_operand_update_stage_valid
add wave -noupdate -expand -group {Internal Signals} -expand -group {LQ operand update stage} /lsq_tb/DUT/LQ_operand_update_stage_linked
add wave -noupdate -expand -group {Internal Signals} -expand -group {LQ operand update stage} /lsq_tb/DUT/next_LQ_operand_update_stage_linked
add wave -noupdate -expand -group {Internal Signals} -expand -group {LQ operand update stage} /lsq_tb/DUT/LQ_operand_update_stage_conditional
add wave -noupdate -expand -group {Internal Signals} -expand -group {LQ operand update stage} /lsq_tb/DUT/next_LQ_operand_update_stage_conditional
add wave -noupdate -expand -group {Internal Signals} -expand -group {LQ operand update stage} /lsq_tb/DUT/LQ_operand_update_stage_read_addr
add wave -noupdate -expand -group {Internal Signals} -expand -group {LQ operand update stage} /lsq_tb/DUT/next_LQ_operand_update_stage_read_addr
add wave -noupdate -expand -group {Internal Signals} -expand -group {LQ operand update stage} /lsq_tb/DUT/LQ_operand_update_stage_LQ_index
add wave -noupdate -expand -group {Internal Signals} -expand -group {LQ operand update stage} /lsq_tb/DUT/next_LQ_operand_update_stage_LQ_index
add wave -noupdate -expand -group {Internal Signals} -expand -group {LQ array} -color Gold -expand -subitemconfig {{/lsq_tb/DUT/LQ_array[3]} {-color Gold -height 16} {/lsq_tb/DUT/LQ_array[2]} {-color Gold -height 16} {/lsq_tb/DUT/LQ_array[1]} {-color Gold -height 16} {/lsq_tb/DUT/LQ_array[0]} {-color Gold -height 16} {/lsq_tb/DUT/LQ_array[0].valid} {-color Gold} {/lsq_tb/DUT/LQ_array[0].ready} {-color Gold} {/lsq_tb/DUT/LQ_array[0].linked} {-color Gold} {/lsq_tb/DUT/LQ_array[0].conditional} {-color Gold} {/lsq_tb/DUT/LQ_array[0].SQ_searched} {-color Gold} {/lsq_tb/DUT/LQ_array[0].SQ_loaded} {-color Gold} {/lsq_tb/DUT/LQ_array[0].dcache_loaded} {-color Gold} {/lsq_tb/DUT/LQ_array[0].ROB_index} {-color Gold} {/lsq_tb/DUT/LQ_array[0].SQ_index} {-color Gold} {/lsq_tb/DUT/LQ_array[0].read_addr} {-color Gold} {/lsq_tb/DUT/LQ_array[0].dest_phys_reg_tag} {-color Gold}} /lsq_tb/DUT/LQ_array
...
add wave -noupdate -expand -group {Internal Signals} -expand -group {SQ array} -color Gold -expand -subitemconfig {{/lsq_tb/DUT/SQ_array[3]} {-color Gold -height 16} {/lsq_tb/DUT/SQ_array[2]} {-color Gold -height 16} {/lsq_tb/DUT/SQ_array[1]} {-color Gold -height 16} {/lsq_tb/DUT/SQ_array[0]} {-color Gold -height 16}} /lsq_tb/DUT/SQ_array
add wave -noupdate -expand -group {Internal Signals} -expand -group {SQ array} -color Gold /lsq_tb/DUT/next_SQ_array
add wave -noupdate -expand -group {Internal Signals} -group {SQ pointers} /lsq_tb/DUT/SQ_head_ptr
add wave -noupdate -expand -group {Internal Signals} -group {SQ pointers} /lsq_tb/DUT/next_SQ_head_ptr
add wave -noupdate -expand -group {Internal Signals} -group {SQ pointers} /lsq_tb/DUT/SQ_tail_ptr
add wave -noupdate -expand -group {Internal Signals} -group {SQ pointers} /lsq_tb/DUT/next_SQ_tail_ptr
add wave -noupdate -expand -group {Internal Signals} -group {SQ pointers} /lsq_tb/DUT/SQ_full
add wave -noupdate -expand -group {Internal Signals} -group {SQ pointers} /lsq_tb/DUT/next_SQ_full
add wave -noupdate -expand -group {Internal Signals} -group {SQ pointers} /lsq_tb/DUT/SQ_empty
add wave -noupdate -expand -group {Internal Signals} -group {SQ pointers} /lsq_tb/DUT/next_SQ_empty
...
WaveRestoreCursors {{Cursor 1} {135600 ps} 0}
